...
async function exportarExcel() {
  console.log("🔥 Iniciando exportarExcel() - versión limpia");
  ...
  try {
    ...
    if (opcion === 'personalizada') {
      console.log("Usuario eligió carpeta personalizada");
      ...
      console.log("Carpeta seleccionada:", carpetaDestino);
    } else {
      console.log("Usuario eligió carpeta de Descargas");
    }
